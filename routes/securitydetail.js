...
module.exports = {
  ...
  upprofileimgwp: (req, res) => {
    ...
    db.query(usernameQuery, (err, result) => {
      ...
      if (result.length > 0) {
        ...
        console.log(req.body.file,"test2");
  ...
  testapp: (req, res) => {
    ...
    let Querycat = "SELECT * FROM `wp_users`";
